...
class CourseData(BaseModel):
    ...
    topics: Optional[List[str]] = None  # Changed from 'topic' to 'topics'
    url_link: Optional[str] = None
    description: Optional[str] = None
    outcomes: Optional[List[str]] = None
    alignment: Optional[List[str]] = None
    keywords: Optional[List[str]] = None  # New field for keywords
...
def extract_data_from_readme(pdf_path: str) -> CourseData:
    ...
    - keywords (list of strings, up to five concise and professional STEM topic keywords based on the course_name, topics, and description)
    ...
    - For keywords, generate up to five concise and professional STEM topic keywords based on the course_name, topics, and description.
    ...
    try:
        ...
        extracted_data = {
            ...
            "contributors": [],
            "academic_levels": [],
            "topics": [],  # Changed from "topic": None
            "url_link": None,
            "description": None,
            "outcomes": [],
            "alignment": [],
    ...
    data = {
        ...
        "topics": extracted_data.get("topics", []) or [],  # Changed from "topic"
        ...
        "keywords": extracted_data.get("keywords", []) or [],  # Added
    }
